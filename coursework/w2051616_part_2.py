...
def view_list(List,listname):      #a function to display each element in all of lists
    for i in List:
        print(f"{listname} -" ,i[0],',',i[1],',',i[2])      #use string formatting method to display list
...
view_list(Progress_list, "Progress")     #calling the function to display progress list with its elements
view_list(Progress_mt_list, "Progress(module trailer)")    #calling the function to display module trailer list with its elements
view_list(Module_ret_list, "Module retriever")    #calling the function to display module retriever list with its elements
view_list(Exclude_list, "Exclude")     #calling the function to display exclude list with its elements
print("EXIT")
print ("---------------------------------------------------------------------------------------")
